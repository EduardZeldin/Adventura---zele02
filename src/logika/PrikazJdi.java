 ...
 * @version 18.5.2017 Provádí příkaz "jdi". Zkouší se vyjít do zadaného
 * prostoru. Pokud prostor existuje, vstoupí se do nového prostoru. Pokud zadaný
 * sousední prostor(východ) není, vypíše se chybové hlášení.
 *
...
public class PrikazJdi implements IPrikaz {
    ...
    /**
     *  /**
     * Tato metoda se stará o veškerou funkcionalitu uvedenou v základním popisu
     * třídy.
     *
     * @return
     */
    ...
    public String provedPrikaz(String... parametry) {
        ...
        if (sousedniProstor == null) {
            ...
            if (smer.equals("3.patro")) {
                if (plan.getAktualniProstor().getNazev().equals("4.patro")) {
                    if (pomocny.obsahujeVec("plast_neviditelnosti")) {
